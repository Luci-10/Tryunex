...
export const PROFILE_ITEMS: MenuItem[] = [
  ...
  { to: "/my-listings", label: "My thrift listings", hint: "Pieces you're selling", icon: Tag, tone: "peach" },
  { to: "/thrift/messages", label: "Thrift messages", hint: "Buyer and seller chats", icon: Chat, tone: "sky" },
  { to: "/thrift/saved", label: "Saved thrift items", hint: "Finds you've kept", icon: Bookmark, tone: "lilac" },
